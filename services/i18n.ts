...
const translations = {
  'zh-CN': {
    ...
    PH_CORE_CN: '例如：感冒 (用于高亮匹配)',
    PH_CORE_EN: '例如：Cold (用于高亮匹配)',
    ...
    LBL_RESULTS: '处理结果',
    BTN_EXPORT: '导出 Excel',
    BTN_IMPORT_EXCEL: '导入 Excel',
    BTN_IMPORT_IMG: '截图识字 (OCR)',
    IMPORT_EXCEL_HINT: '格式说明：系统将读取第一个工作表（Sheet）的第一列内容作为翻译项。',
    EMPTY_RESULTS: '暂无结果',
    NOT_FOUND: '未找到',
    ...
    TOAST_IMPORT_EXCEL_SUCCESS: '成功从 Excel 导入 {count} 条内容',
    TOAST_IMPORT_EXCEL_FAIL: 'Excel 解析失败',
    TOAST_OCR_PROCESSING: '正在识别截图文字，请稍候...',
    TOAST_OCR_SUCCESS: '识别成功，已添加 {count} 行',
    TOAST_OCR_FAIL: '图片识别失败',
    HINT_PASTE_IMAGE: '[ 支持直接复制截图后 Ctrl+V 粘贴识别网页或图片中的文字 ]',
    OCR_DRAG_HINT: '将图片拖拽至此',
    OCR_PASTE_HINT: '或截图后 Ctrl + V / Command + V 粘贴图片',
    OCR_FORMATS: '支持格式：jpg / jpeg / png / gif / webp',
    OCR_BTN_UPLOAD: '上传图片',
    OCR_BTN_CONFIRM: '填入批量翻译框',
    OCR_EDIT_HINT: '可在此校对或重新编辑识别结果...',
    OCR_TITLE: '截图识字 (OCR)',
    ...
    HINT_BAIDU_KEY: '使用百度千帆大模型平台的 API Key',
    HINT_LOCAL_STORAGE: 'Key仅存储在本地浏览器中，绝不会上传至服务器',
  ...
  'en-US': {
    ...
    LBL_CORE_CN: 'Core Chinese',
    LBL_CORE_EN: 'Core English',
    ...
    PH_CORE_CN: 'e.g. 感冒 (for matching)',
    PH_CORE_EN: 'e.g. Cold (for matching)',
    ...
    IMP_STEP2_TITLE: '2. Enrich Data (Pinyin & Core Terms)',
    BTN_DONE: 'Done',
    ...
    BTN_IMPORT_IMG: 'Image OCR',
    IMPORT_EXCEL_HINT: 'Format: System reads the first column of the first sheet as translation items.',
    ...
    TOAST_IMPORT_EXCEL_SUCCESS: 'Successfully imported {count} items from Excel',
    TOAST_IMPORT_EXCEL_FAIL: 'Failed to parse Excel file',
    TOAST_OCR_PROCESSING: 'Recognizing image text...',
    TOAST_OCR_SUCCESS: 'OCR Success, {count} lines added',
    TOAST_OCR_FAIL: 'OCR Failed',
    HINT_PASTE_IMAGE: '[ You can also Ctrl+V to paste an image for OCR ]',
    OCR_DRAG_HINT: 'Drag image here',
    OCR_PASTE_HINT: 'or paste image using Ctrl + V / Command + V',
    OCR_FORMATS: 'Supported formats: jpg / jpeg / png / gif / webp',
    OCR_BTN_UPLOAD: 'Upload Image',
    OCR_BTN_CONFIRM: 'Fill into Translation Box',
    OCR_EDIT_HINT: 'Correct or edit the recognized text here...',
    OCR_TITLE: 'Image OCR',
    ...
    HINT_BAIDU_KEY: 'Use Baidu Qianfan Platform API Key',
